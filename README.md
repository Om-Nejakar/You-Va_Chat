...
- GitHub: [@Om-Nejakar](https://github.com/Om-Nejakar)
- LinkedIn: [Om Nejakar](https://www.linkedin.com/in/om-nejakar/)

## Acknowledgments

- Built with [Streamlit](https://streamlit.io/)
- Powered by [Google Gemini](https://deepmind.google/technologies/gemini/)
- OpenAI integration via [OpenRouter](https://openrouter.ai/)
